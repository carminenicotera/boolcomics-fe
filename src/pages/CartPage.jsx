...
export default function CartPage({ cart, removeFromCart }) {
  ...
  const amountLeft = SHIPPING_THRESHOLD - total;
            ...
            <div className="card p-4 border-0 shadow-sm bg-dark text-white">
              ...
              {shippingCost > 0 && (
                <p className="text-warning small mb-4">
                  Ti mancano €{amountLeft.toFixed(2)} per la spedizione gratuita!
                </p>
              )}
              {shippingCost === 0 && (
              ...
              <div className="d-flex justify-content-between mb-4">
                ...
                <span className="h4 m-0 text-warning fw-bold">€{(total + shippingCost).toFixed(2)}</span>
              </div>
